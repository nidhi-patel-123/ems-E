...
//     socketRef.current = io("https://ems-b-86xl.onrender.com", {
...
//     try {
//       const response = await fetch("https://ems-b-86xl.onrender.com/employee/notifications", {
//         headers: {
...
//     try {
//       await fetch(`https://ems-b-86xl.onrender.com/notifications/${id}/read`, {
//         method: "PATCH",
//         headers: {
//           Authorization: `Bearer ${sessionStorage.getItem("employeeToken")}`,
//         },
...
//       try {
//         const response = await fetch(`https://ems-b-86xl.onrender.com/notifications/${id}`, {
//           method: "DELETE",
//           headers: {
//             Authorization: `Bearer ${sessionStorage.getItem("employeeToken")}`,
//             'x-user-id': sessionStorage.getItem("employeeId") || '',
...
const Header = ({ userName = "Employee" }) => {
  ...
  useEffect(() => {
    socketRef.current = io("https://ems-b-86xl.onrender.com", { withCredentials: true });
